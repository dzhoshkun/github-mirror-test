# -*- coding: utf-8 -*-
#
# github-mirror-test documentation build configuration file, created by
...
project = u'github-mirror-test'
copyright = u'2017, Dzhoshkun Shakir'
author = u'Dzhoshkun Shakir'
...
html_theme_options = {
    ...
    "sidebarbgcolor": "#DDDDD6",  # (CSS color): Background color for the sidebar.
    # sidebarbtncolor (CSS color): Background color for the sidebar collapse button (used when collapsiblesidebar is True).
    "sidebartextcolor": "#0A0A0A",  # (CSS color): Text color for the sidebar.
    "sidebarlinkcolor": "#CC0000",  # (CSS color): Link color for the sidebar.
...
htmlhelp_basename = 'github-mirror-testdoc'
...
latex_documents = [
    (master_doc, 'github-mirror-test.tex', u'github-mirror-test Documentation',
     u'Dzhoshkun Shakir', 'manual'),
]
...
man_pages = [
    (master_doc, 'github-mirror-test', u'github-mirror-test Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'github-mirror-test', u'github-mirror-test Documentation',
     author, 'github-mirror-test', 'One line description of project.',
     'Miscellaneous'),
]
